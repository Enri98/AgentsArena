...
>
> Recommended next branch: decide the next explicit plan section after Phase 17. Prefer a narrow pure in-process adapter contract or another small deterministic game; do not add FastAPI, WebSockets, persistence, subprocesses, timeouts, auth, matchmaking, or UI payloads without a new plan section and tests.
